...
Below, is an example of the entire code, including the "devtools" and "ExerciseHRCode" installations. *Note: This example is for running the code on a Mac. If you are using a Windows, you will need to replace the "*/*" slash in the output_folder line with the following two slashes: "*\\\\*". DO NOT change the slash in "briabartsch/ExerciseHRCode".*
